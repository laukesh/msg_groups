...
class ProcurementAwardController extends Controller
{
    ...
    */
    ...
    public function edit(
        ...
        abort_unless(
            $award->procurement_tender_id === $procurementTender->id,
            404
        );

        abort_unless(
            in_array($award->status, [
                'Draft',
                'Under Review',
            ]),
            403,
            'This Award cannot be edited in its current status.'
        );
    ...
    */
    ...
    public function update(
        ...
        */
        ...
        /*
        |--------------------------------------------------------------------------
        | Only Draft / Under Review can be edited
        |--------------------------------------------------------------------------
        */

        if (!in_array($award->status, [
            'Draft',
            'Under Review',
        ])) {
