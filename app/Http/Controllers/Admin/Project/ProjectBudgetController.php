    ...
    */
    ...
    public function submit(
        ...
        */
        ...
        if (
            ...
            return back()
                ->with(
                    'error',
                    'Only Draft or Rejected budgets can be submitted for review.'
                );
        }
        ...
        */
        ...
        if (
            (float) $projectBudget->total_budget <= 0
        ) {
        ...
        */
        ...
        return back()
            ->with(
                'success',
                'Budget submitted for review successfully.'
            );
    }
    ...
    public function approve(
        ...
        /*
        |--------------------------------------------------------------------------
        | Only Under Review Can Be Approved
        |--------------------------------------------------------------------------
        */

        if (
            $projectBudget->status !== 'Under Review'
        ) {

            return back()
                ->with(
                    'error',
                    'Only budgets under review can be approved.'
                );
        }
    ...
    public function reject(
        ...
        /*
        |--------------------------------------------------------------------------
        | Only Under Review Can Be Rejected
        |--------------------------------------------------------------------------
        */
        ...
        if (
            ...
            return back()
                ->with(
                    'error',
                    'Only budgets under review can be rejected.'
                );
        }
