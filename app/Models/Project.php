...
class Project extends Model
{
    ...
    */
    ...
    public function commissioningScopes()
    {
        return $this->hasMany(
            \App\Models\CommissioningScope::class
        );
    }

    public function commissioningTestPlans()
    {
        return $this->hasMany(
            \App\Models\CommissioningTestPlan::class
        );
    }

    public function commissioningTests()
    {
        return $this->hasMany(
            \App\Models\CommissioningTest::class
        );
    }

    public function commissioningCertificates()
    {
        return $this->hasMany(
            \App\Models\CommissioningCertificate::class
        );
    }

    public function handoverProjects(): HasMany
    {
        return $this->hasMany(
    ...
    public function handoverSnags(): HasMany
    {
        return $this->hasMany(
            HandoverSnag::class,
            'project_id'
    ...
    {
        return $this->hasMany(ConstructionMaterialStock::class, 'project_id');
    }
