...
@section('title', 'Edit Daily Manpower Entry')
...
<div class="container-fluid">
    ...
    <form method="POST"
          action="{{ route(
              'admin.projects.construction.manpower.entries.update',
              [
                  'project' => $project,
                  'entry' => $entry
              ]
            ...
            <div class="card-body">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="form-text">
                            Only active assignments can be used for daily entries.
                        </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text"
                               ...
                               class="form-control"
                               value="{{ number_format($entry->total_hours, 2) }}"
                               readonly>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text"
                                   ...
                                   class="form-control"
                                   value="{{ number_format($entry->daily_rate, 2, '.', '') }}"
                                   readonly>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text"
                                   ...
                                   value="{{ number_format($entry->total_cost, 2, '.', '') }}"
                                   readonly>
            ...
            <div class="card-body">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                            ...
                            @foreach($workOrders as $workOrder)
                                ...
                                <option value="{{ $workOrder->id }}"
                                    {{ old(
                                        ...
                                        $entry->construction_work_order_id
                        ...
                        <div class="form-text">
                            Leave blank to use the assignment work order.
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea name="work_description"
                                  ...
                                  placeholder="Describe work performed">{{ old(
                                      'work_description',
