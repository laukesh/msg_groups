...
<div class="container-fluid">
    ...
    <form method="POST"
          action="{{ route(
              'admin.projects.construction.risks.store',
              $project
          ) }}">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="date"
                               name="risk_date"
                               class="form-control"
                               value="{{ old('risk_date', date('Y-m-d')) }}"
                               required>
                        ...
                        <select name="risk_category"
                            ...
                            @foreach([
                                ...
                                <option value="{{ $category }}"
                                    @selected(old('risk_category') === $category)>
                                    {{ $category }}
                                </option>
                        ...
                        <select name="construction_schedule_activity_id"
                            ...
                            @foreach($scheduleActivities as $activity)
                                ...
                                <option value="{{ $activity->id }}"
                                    @selected(
                                        old('construction_schedule_activity_id')
                                        == $activity->id
                                    )>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number"
                               ...
                               min="0"
                               step="0.01"
                               value="{{ old('potential_cost_impact', 0) }}">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number"
                               ...
                               class="form-control"
                               min="0"
                               value="{{ old('potential_delay_days', 0) }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea name="risk_description"
                                  class="form-control"
                                  rows="4">{{ old('risk_description') }}</textarea>
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea name="risk_cause"
                                  class="form-control"
                                  rows="4">{{ old('risk_cause') }}</textarea>
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="potential_impact"
                                  class="form-control"
                                  rows="4">{{ old('potential_impact') }}</textarea>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="response_plan"
                                  class="form-control"
                                  rows="4">{{ old('response_plan') }}</textarea>
