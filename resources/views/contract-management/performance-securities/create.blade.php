...
<div class="container-fluid">
        ...
        <div class="card-body">
            ...
            @if(!$contract->performance_security_required)
                ...
                <div class="alert alert-warning mt-4 mb-0">
                    ...
                    Performance security is currently marked as
                    <strong>not required</strong> for this contract.

                    You can still record a security if required by
                    the contract or subsequent instruction.
    ...
    <form method="POST"
          action="{{ route(
              'admin.projects.contract-management.contracts.performance-securities.store',
              [$project, $contract]
          ) }}">
            ...
            <div class="card-body">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-text">
                            Keep 0 if no amount has been released.
                        </div>
            ...
            <div class="card-body">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-text">
                            Applicable where the instrument has a
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="date"
                               ...
                               value="{{ old('extended_expiry_date') }}"
        ...
        <div class="card shadow-sm mb-4">
            ...
            <div class="card-body">
                ...
                <textarea name="release_remarks"
                          ...
                          placeholder="Enter release details or remarks...">{{ old('release_remarks') }}</textarea>
