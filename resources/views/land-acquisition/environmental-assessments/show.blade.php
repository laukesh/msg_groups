...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            ...
            <a
                href="{{ route(
                    'admin.land.lands.environmental-assessments.edit',
                    [
                        $land,
                        $dueDiligence
                    ]
    ...
    <div class="card mb-4">
        ...
        <div class="card-header">
            <strong>Environmental Assessment Summary</strong>
        </div>
        ...
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <form
                    method="POST"
                    action="{{ route(
                        'admin.land.lands.environmental-assessments.destroy',
                        [
                            $land,
                            $dueDiligence
                        ]
                    ) }}"
                    onsubmit="return confirm('Are you sure you want to delete this environmental assessment?');"
                >
