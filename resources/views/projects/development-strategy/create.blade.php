...
<div class="container-fluid">
    ...
    <form
        method="POST"
        action="{{ route(
            'admin.projects.development-strategy.store',
            ['project' => $project->id]
        ) }}"
    >
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <div class="alert alert-info small">
                    ...
                    The Strategy Number will be generated automatically
                    when the Development Strategy is created.
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 mb-3">
                        ...
                        <input
                            ...
                            value="{{ old('title') }}"
                            placeholder="e.g. Integrated Commercial Development Strategy"
                            required
                        >
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <textarea
                        ...
                        rows="4"
                        class="form-control"
                        placeholder="Define the long-term vision for the development."
                    >{{ old('development_vision') }}</textarea>
                ...
                <div class="mb-3">
                    ...
                    >{{ old('development_concept') }}</textarea>
                ...
                <div class="mb-0">
                    ...
                    <textarea
                        ...
                        rows="5"
                        class="form-control"
                        placeholder="List the strategic objectives of the development."
                    >{{ old('development_objectives') }}</textarea>
            ...
            <div class="card-body">
                ...
                <div class="mb-0">
                    ...
                    <textarea
                        ...
                        rows="5"
                        class="form-control"
                        placeholder="Explain how the development will be approached."
                    >{{ old('development_approach') }}</textarea>
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <textarea
                        ...
                        rows="4"
                        class="form-control"
                        placeholder="Describe the intended market positioning."
                    >{{ old('market_positioning') }}</textarea>
                ...
                <div class="mb-0">
                    ...
                    <textarea
                        ...
                        rows="4"
                        class="form-control"
                        placeholder="Describe the competitive strategy."
                    >{{ old('competitive_strategy') }}</textarea>
            ...
            <div class="card-body">
                ...
                <div class="mb-4">
                    ...
                    <textarea
                        ...
                        rows="4"
                        class="form-control"
                        placeholder="Describe the proposed development mix."
                    >{{ old('development_mix') }}</textarea>
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <textarea
                        ...
                        rows="4"
                        class="form-control"
                        placeholder="Document the key assumptions supporting the strategy."
                ...
                <div class="mb-3">
                    ...
                    <textarea
                        ...
                        rows="4"
                        class="form-control"
                        placeholder="Document strategic constraints."
                    >{{ old('strategic_constraints') }}</textarea>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <textarea
                            ...
                            rows="5"
                            class="form-control"
                            placeholder="Identify key development opportunities."
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <textarea
                            ...
                            rows="5"
                            class="form-control"
                            placeholder="Identify key development challenges."
                        >{{ old('key_challenges') }}</textarea>
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <textarea
                        ...
                        rows="5"
                        class="form-control"
                        placeholder="Describe the recommended development strategy."
                    >{{ old('recommended_strategy') }}</textarea>
                ...
                <div class="mb-0">
                    ...
                    <textarea
                        ...
                        rows="5"
                        class="form-control"
                        placeholder="Explain why this strategy is recommended."
                    >{{ old('strategic_rationale') }}</textarea>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="form-text">
                            We will connect this to the existing user /
                            employee master later.
                        </div>
