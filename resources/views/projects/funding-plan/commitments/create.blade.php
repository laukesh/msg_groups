...
<div class="container-fluid">
    ...
    <form
        method="POST"
        action="{{ route(
            'admin.projects.funding-plan.commitments.store',
            [
                'project' => $project->id,
                'fundingPlan' => $fundingPlan->id,
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input
                            ...
                            placeholder="Sanction / agreement / approval reference"
                        >
            ...
            <div class="card-body">
                ...
                @php
                    $remainingAmount =
                        max(
                            ...
                            (float) $fundingSource->committed_amount,
                            0
                        );
                @endphp
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="form-text">
                            Approved amount cannot exceed committed amount.
                        </div>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <textarea
                    ...
                    placeholder="Enter commitment remarks..."
