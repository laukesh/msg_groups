...
<div class="container-fluid">
    ...
    <form
        method="POST"
        action="{{ route(
            'admin.projects.governance-meetings.attendees.update',
            [
                'project' => $project->id,
                'meeting' => $meeting->id,
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="form-text">
                            Select a system user or leave blank
                            for an external participant.
                        </div>
        ...
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div>
                    ...
                    <div class="text-muted small">
                        This removes the attendee from this meeting.
                    </div>
                ...
                <form
                    ...
                    onsubmit="return confirm(
                        'Are you sure you want to remove this attendee from the meeting?'
                    );"
                >
