...
<div class="container-fluid">
    ...
    <form
        method="POST"
        action="{{ route(
            'admin.projects.governance.store',
            ['project' => $project->id]
        ) }}"
    >
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 mb-3">
                        ...
                        <input
                            ...
                            placeholder="Enter governance framework title"
                            required
                        >
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                >{{ old('governance_objective') }}</textarea>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                >{{ old('decision_making_framework') }}</textarea>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                >{{ old('approval_framework') }}</textarea>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                >{{ old('escalation_framework') }}</textarea>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                >{{ old('reporting_framework') }}</textarea>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                >{{ old('meeting_framework') }}</textarea>
