...
<div class="container-fluid">
    ...
    <form
        method="POST"
        action="{{ route(
            'admin.projects.master-schedule.store',
            ['project' => $project->id]
        ) }}"
    >
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <div class="alert alert-info small">
                    ...
                    The Schedule Number will be generated automatically
                    when the Master Schedule is created.
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 mb-3">
                        ...
                        <input
                            ...
                            value="{{ old('title') }}"
                            placeholder="e.g. Project Master Development Schedule"
                            required
                        >
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <div class="alert alert-secondary small">
                    ...
                    schedule against which future project performance
                    will be measured.
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input
                            ...
                            value="{{ old('baseline_completion_date') }}"
                        >
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input
                            ...
                            value="{{ old('current_completion_date') }}"
                        >
