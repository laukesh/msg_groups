...
/*commissioning*/
use App\Http\Controllers\Admin\Commissioning\CommissioningManagementController;
use App\Http\Controllers\Admin\Commissioning\CommissioningDashboardController;
use App\Http\Controllers\Admin\Commissioning\CommissioningScopeController;
use App\Http\Controllers\Admin\Commissioning\CommissioningTestPlanController;
use App\Http\Controllers\Admin\Commissioning\CommissioningTestController;
use App\Http\Controllers\Admin\Commissioning\CommissioningCertificateController;
use App\Http\Controllers\Admin\Commissioning\CommissioningDocumentController;
use App\Http\Controllers\Admin\Commissioning\CommissioningAuditController;


/*handover*/

use App\Http\Controllers\Admin\Handover\HandoverController as ProjectHandoverController;

use App\Http\Controllers\Admin\Handover\HandoverManagementController;
use App\Http\Controllers\Admin\Handover\HandoverRequirementController;
use App\Http\Controllers\Admin\Handover\HandoverSnagController;
use App\Http\Controllers\Admin\Handover\HandoverDocumentController;
use App\Http\Controllers\Admin\Handover\HandoverDefectController;
use App\Http\Controllers\Admin\Handover\HandoverPracticalCompletionController;
use App\Http\Controllers\Admin\Handover\HandoverFinalCompletionController;
use App\Http\Controllers\Admin\Handover\HandoverFinalAccountController;
use App\Http\Controllers\Admin\Handover\HandoverFinalPaymentController;
use App\Http\Controllers\Admin\Handover\HandoverCertificateController;
use App\Http\Controllers\Admin\Handover\HandoverAssetHandoverController;
...
Route::get('/admin/test-home', [HomeController::class, 'index'])
                            ...
                            Route::prefix('{project}/budget')
                                ...
                                ->group(function () {
                                    ...
                                    */
                                    ...
                                    Route::post(
							            '/{projectBudget}/submit',
							            [ProjectBudgetController::class, 'submit']
							        )->name('submit');

							        Route::post(
							            '/{projectBudget}/approve',
							            [ProjectBudgetController::class, 'approve']
							        )->name('approve');

							        Route::post(
							            '/{projectBudget}/reject',
							            [ProjectBudgetController::class, 'reject']
							        )->name('reject');
            ...
            Route::prefix('projects/{project}/funding-plan')
                ...
                ->group(function () {
                    ...
                    */
                    ...
                    Route::get(
                        '/tenders/{procurementTender}/awards/{award}/edit',
                        [ProcurementAwardController::class, 'edit']
                    )->name('tenders.awards.edit');

                    Route::put(
					    'tenders/{procurementTender}/awards/{award}',
					    [ProcurementAwardController::class, 'update']
					)->name('tenders.awards.update');
                ...
                */
                ...
                Route::prefix('projects/{project}/construction/delays')
					...
					Route::get(
					    '/commissioning',
					    [CommissioningManagementController::class, 'index']
					)->name('commissioning.index');

					// Primary project/construction route.
					Route::prefix('projects/{project}/commissioning')
					    ->name('projects.commissioning.')
					    ->group(function () {
					        Route::get('/', [CommissioningDashboardController::class, 'index'])->name('index');
					    Route::resource('scopes', CommissioningScopeController::class);
					    Route::resource('test-plans', CommissioningTestPlanController::class);
					    Route::post(
						    'test-plans/{test_plan}/submit',
						    [CommissioningTestPlanController::class, 'submit']
						)->name('test-plans.submit');

						Route::post(
						    'test-plans/{test_plan}/approve',
						    [CommissioningTestPlanController::class, 'approve']
						)->name('test-plans.approve');

						Route::post(
						    'test-plans/{test_plan}/reject',
						    [CommissioningTestPlanController::class, 'reject']
						)->name('test-plans.reject');

						Route::post(
						    'test-plans/{test_plan}/hold',
						    [CommissioningTestPlanController::class, 'hold']
						)->name('test-plans.hold');

						Route::post(
						    'test-plans/{test_plan}/resume',
						    [CommissioningTestPlanController::class, 'resume']
						)->name('test-plans.resume');

						Route::post(
						    'test-plans/{test_plan}/start',
						    [CommissioningTestPlanController::class, 'start']
						)->name('test-plans.start');

						Route::post(
						    'test-plans/{test_plan}/complete',
						    [CommissioningTestPlanController::class, 'complete']
						)->name('test-plans.complete');


					    
					    Route::resource('tests', CommissioningTestController::class);
					    Route::get(
						    'tests/{test}/retest',
						    [CommissioningTestController::class, 'createRetest']
						)->name('tests.retest.create');
					    Route::resource('certificates', CommissioningCertificateController::class);

					    Route::post(
						    'certificates/{certificate}/submit',
						    [CommissioningCertificateController::class, 'submit']
						)->name('certificates.submit');

						Route::post(
						    'certificates/{certificate}/approve',
						    [CommissioningCertificateController::class, 'approve']
						)->name('certificates.approve');

						Route::post(
						    'certificates/{certificate}/reject',
						    [CommissioningCertificateController::class, 'reject']
						)->name('certificates.reject');

						Route::post(
						    'certificates/{certificate}/expire',
						    [CommissioningCertificateController::class, 'expire']
						)->name('certificates.expire');

					    Route::get(
						    'documents',
						    [CommissioningDocumentController::class, 'index']
						)->name('documents.index');

						Route::get(
						    'documents/create',
						    [CommissioningDocumentController::class, 'create']
						)->name('documents.create');

						Route::post(
						    'documents',
						    [CommissioningDocumentController::class, 'store']
						)->name('documents.store');

						Route::get(
						    'documents/{document}/download',
						    [CommissioningDocumentController::class, 'download']
						)->name('documents.download');

						Route::delete(
						    'documents/{document}',
						    [CommissioningDocumentController::class, 'destroy']
						)->name('documents.destroy');
						Route::get(
						    'audit-trail',
						    [CommissioningAuditController::class, 'index']
						)->name('audit.index');
			    ...
			    ->group(function () {
			        ...
			        Route::get('/', [
			            HandoverManagementController::class,
			            'index'
			        ])->name('index');

			        Route::post('projects/{project}/start', [
			            HandoverManagementController::class,
			            'start'
			        ])->name('projects.start');
				...
				Route::prefix('projects/{project}/handover')
			    ->name('projects.handover.')
			    ->group(function () {

			        Route::get(
			            '/',
			            [ProjectHandoverController::class, 'index']
			        )->name('index');

			    });

			    Route::prefix('projects/{project}/handover/requirements')
			    ->name('projects.handover.requirements.')
			    ->group(function () {

			        Route::get('/', [
			            HandoverRequirementController::class,
			            'index'
			        ])->name('index');
			        ...
			        Route::put('/{requirement}', [
			            HandoverRequirementController::class,
			            'update'
			        ])->name('update');

			        Route::delete('/{requirement}', [
			            HandoverRequirementController::class,
			            'destroy'
			        ])->name('destroy');

			        Route::post('/{requirement}/start', [
			            HandoverRequirementController::class,
			            'start'
			        ])->name('start');
			        ...
			        Route::post('/{requirement}/review', [
			            HandoverRequirementController::class,
			            'review'
			        ])->name('review');

			        Route::post('/{requirement}/complete', [
			            HandoverRequirementController::class,
			            'complete'
			        ])->name('complete');

			        Route::post('/{requirement}/reject', [
			            HandoverRequirementController::class,
			            'reject'
			        ])->name('reject');

			        Route::post('/{requirement}/waive', [
			            HandoverRequirementController::class,
			            'waive'
			        ])->name('waive');
			    ...
			    Route::prefix('projects/{project}/handover/snags')
			    ->name('projects.handover.snags.')
			    ->group(function () {

			        Route::get('/', [HandoverSnagController::class, 'index'])
			            ->name('index');

			        Route::post('/', [HandoverSnagController::class, 'store'])
			            ->name('store');

			        Route::put('/{snag}', [HandoverSnagController::class, 'update'])
			            ->name('update');

			        Route::delete('/{snag}', [HandoverSnagController::class, 'destroy'])
			            ->name('destroy');

			        Route::post('/{snag}/assign', [HandoverSnagController::class, 'assign'])
			            ->name('assign');

			        Route::post('/{snag}/start', [HandoverSnagController::class, 'start'])
			            ->name('start');

			        Route::post('/{snag}/submit-rectification', [
			            HandoverSnagController::class,
			            'submitRectification'
			        ])->name('submit-rectification');

			        Route::post('/{snag}/verify', [HandoverSnagController::class, 'verify'])
			            ->name('verify');

			        Route::post('/{snag}/reject', [HandoverSnagController::class, 'reject'])
			            ->name('reject');

			        Route::post('/{snag}/close', [HandoverSnagController::class, 'close'])
			            ->name('close');
			    });

			    Route::prefix('projects/{project}/handover/documents')
			    ->name('projects.handover.documents.')
			    ->group(function () {

			        Route::get(
			            '/',
			            [HandoverDocumentController::class, 'index']
			        )->name('index');

			        Route::post(
			            '/',
			            [HandoverDocumentController::class, 'store']
			        )->name('store');

			        Route::put(
			            '/{document}',
			            [HandoverDocumentController::class, 'update']
			        )->name('update');

			        Route::delete(
			            '/{document}',
			            [HandoverDocumentController::class, 'destroy']
			        )->name('destroy');

			        Route::post(
			            '/{document}/submit',
			            [HandoverDocumentController::class, 'submit']
			        )->name('submit');

			        Route::post(
			            '/{document}/review',
			            [HandoverDocumentController::class, 'review']
			        )->name('review');

			        Route::post(
			            '/{document}/approve',
			            [HandoverDocumentController::class, 'approve']
			        )->name('approve');

			        Route::post(
			            '/{document}/reject',
			            [HandoverDocumentController::class, 'reject']
			        )->name('reject');

			        Route::post(
			            '/{document}/archive',
			            [HandoverDocumentController::class, 'archive']
			        )->name('archive');
			    });

			    Route::prefix('projects/{project}/handover/defects')
			    ->name('projects.handover.defects.')
			    ->group(function () {

			        Route::get(
			            '/',
			            [HandoverDefectController::class, 'index']
			        )->name('index');

			        Route::post(
			            '/',
			            [HandoverDefectController::class, 'store']
			        )->name('store');

			        Route::put(
			            '/{defect}',
			            [HandoverDefectController::class, 'update']
			        )->name('update');

			        Route::delete(
			            '/{defect}',
			            [HandoverDefectController::class, 'destroy']
			        )->name('destroy');

			        Route::post(
			            '/{defect}/assign',
			            [HandoverDefectController::class, 'assign']
			        )->name('assign');

			        Route::post(
			            '/{defect}/start',
			            [HandoverDefectController::class, 'start']
			        )->name('start');

			        Route::post(
			            '/{defect}/submit-rectification',
			            [HandoverDefectController::class, 'submitRectification']
			        )->name('submit-rectification');

			        Route::post(
			            '/{defect}/verify',
			            [HandoverDefectController::class, 'verify']
			        )->name('verify');

			        Route::post(
			            '/{defect}/reject',
			            [HandoverDefectController::class, 'reject']
			        )->name('reject');

			        Route::post(
			            '/{defect}/close',
			            [HandoverDefectController::class, 'close']
			        )->name('close');
			    });

			    Route::prefix('projects/{project}/handover/practical-completion')
			    ->name('projects.handover.practical-completion.')
			    ->group(function () {

			        Route::get(
			            '/',
			            [HandoverPracticalCompletionController::class, 'index']
			        )->name('index');

			        Route::put(
			            '/{completion}',
			            [HandoverPracticalCompletionController::class, 'update']
			        )->name('update');

			        Route::post(
			            '/{completion}/submit',
			            [HandoverPracticalCompletionController::class, 'submit']
			        )->name('submit');

			        Route::post(
			            '/{completion}/review',
			            [HandoverPracticalCompletionController::class, 'review']
			        )->name('review');

			        Route::post(
			            '/{completion}/approve',
			            [HandoverPracticalCompletionController::class, 'approve']
			        )->name('approve');

			        Route::post(
			            '/{completion}/reject',
			            [HandoverPracticalCompletionController::class, 'reject']
			        )->name('reject');
			    });

			    Route::prefix('projects/{project}/handover/final-completion')
			    ->name('projects.handover.final-completion.')
			    ->group(function () {

			        Route::get(
			            '/',
			            [HandoverFinalCompletionController::class, 'index']
			        )->name('index');

			        Route::put(
			            '/{completion}',
			            [HandoverFinalCompletionController::class, 'update']
			        )->name('update');

			        Route::post(
			            '/{completion}/submit',
			            [HandoverFinalCompletionController::class, 'submit']
			        )->name('submit');

			        Route::post(
			            '/{completion}/review',
			            [HandoverFinalCompletionController::class, 'review']
			        )->name('review');

			        Route::post(
			            '/{completion}/approve',
			            [HandoverFinalCompletionController::class, 'approve']
			        )->name('approve');

			        Route::post(
			            '/{completion}/reject',
			            [HandoverFinalCompletionController::class, 'reject']
			        )->name('reject');
			    });

			    Route::prefix('projects/{project}/handover/final-account')
			    ->name('projects.handover.final-account.')
			    ->group(function () {
			        Route::get('/', [HandoverFinalAccountController::class, 'index'])->name('index');
			        Route::get('/create', [HandoverFinalAccountController::class, 'create'])->name('create');
			        Route::post('/', [HandoverFinalAccountController::class, 'store'])->name('store');

			        Route::get('/{account}', [HandoverFinalAccountController::class, 'show'])->name('show');
			        Route::get('/{account}/edit', [HandoverFinalAccountController::class, 'edit'])->name('edit');
			        Route::put('/{account}', [HandoverFinalAccountController::class, 'update'])->name('update');

			        Route::get('/{account}/payments', [HandoverFinalAccountController::class, 'payments'])->name('payments');

			        Route::post('/{account}/submit', [HandoverFinalAccountController::class, 'submit'])->name('submit');
			        Route::post('/{account}/review', [HandoverFinalAccountController::class, 'review'])->name('review');
			        Route::post('/{account}/approve', [HandoverFinalAccountController::class, 'approve'])->name('approve');

			        Route::get('/{account}/reject', [HandoverFinalAccountController::class, 'rejectForm'])->name('reject.form');
			        Route::post('/{account}/rejection', [HandoverFinalAccountController::class, 'reject'])->name('reject');
			    });

				Route::prefix('projects/{project}/handover/final-payment')
				    ->name('projects.handover.final-payment.')
				    ->group(function () {

				        Route::get('/', [
				            HandoverFinalPaymentController::class,
				            'index'
				        ])->name('index');

				        Route::post('/{finalAccount}/store', [
				            HandoverFinalPaymentController::class,
				            'store'
				        ])->name('store');
				        ...
				        Route::put('/payment/{payment}', [
				            HandoverFinalPaymentController::class,
				            'update'
				        ])->name('update');


				        Route::post('/payment/{payment}/submit', [
				            HandoverFinalPaymentController::class,
				            'submit'
				        ])->name('submit');

				        Route::post('/payment/{payment}/review', [
				            HandoverFinalPaymentController::class,
				            'review'
				        ])->name('review');
				        ...
				        Route::post('/payment/{payment}/paid', [
				            HandoverFinalPaymentController::class,
				            'paid'
				        ])->name('paid');
				        ...
				        Route::post('/payment/{payment}/cancel', [
				            HandoverFinalPaymentController::class,
				            'cancel'
				        ])->name('cancel');
			    ...
			    Route::prefix('projects/{project}/handover/certificates')
			    ->name('projects.handover.certificates.')
			    ->group(function () {

			        Route::get(
			            '/',
			            [HandoverCertificateController::class, 'index']
			        )->name('index');

			        Route::post(
			            '/',
			            [HandoverCertificateController::class, 'store']
			        )->name('store');

			        Route::put(
			            '/{certificate}',
			            [HandoverCertificateController::class, 'update']
			        )->name('update');

			        Route::post(
			            '/{certificate}/submit',
			            [HandoverCertificateController::class, 'submit']
			        )->name('submit');

			        Route::post(
			            '/{certificate}/review',
			            [HandoverCertificateController::class, 'review']
			        )->name('review');

			        Route::post(
			            '/{certificate}/approve',
			            [HandoverCertificateController::class, 'approve']
			        )->name('approve');

			        Route::post(
			            '/{certificate}/reject',
			            [HandoverCertificateController::class, 'reject']
			        )->name('reject');

			        Route::post(
			            '/{certificate}/cancel',
			            [HandoverCertificateController::class, 'cancel']
			        )->name('cancel');
			    });

			    Route::prefix('projects/{project}/handover/asset-handover')
			    ->name('projects.handover.asset-handover.')
			    ->group(function () {

			        Route::get(
			            '/',
			            [HandoverAssetHandoverController::class, 'index']
			        )->name('index');

			        Route::post(
			            '/',
			            [HandoverAssetHandoverController::class, 'store']
			        )->name('store');

			        Route::put(
			            '/{assetHandover}',
			            [HandoverAssetHandoverController::class, 'update']
			        )->name('update');

			        Route::post(
			            '/{assetHandover}/items',
			            [HandoverAssetHandoverController::class, 'addItem']
			        )->name('items.store');

			        Route::put(
			            '/{assetHandover}/items/{item}',
			            [HandoverAssetHandoverController::class, 'updateItem']
			        )->name('items.update');

			        Route::post(
			            '/{assetHandover}/items/{item}/verify',
			            [HandoverAssetHandoverController::class, 'verifyItem']
			        )->name('items.verify');

			        Route::post(
			            '/{assetHandover}/items/{item}/accept',
			            [HandoverAssetHandoverController::class, 'acceptItem']
			        )->name('items.accept');

			        Route::post(
			            '/{assetHandover}/items/{item}/reject',
			            [HandoverAssetHandoverController::class, 'rejectItem']
			        )->name('items.reject');

			        Route::delete(
			            '/{assetHandover}/items/{item}',
			            [HandoverAssetHandoverController::class, 'removeItem']
			        )->name('items.destroy');

			        Route::post(
			            '/{assetHandover}/submit',
			            [HandoverAssetHandoverController::class, 'submit']
			        )->name('submit');

			        Route::post(
			            '/{assetHandover}/review',
			            [HandoverAssetHandoverController::class, 'review']
			        )->name('review');

			        Route::post(
			            '/{assetHandover}/approve',
			            [HandoverAssetHandoverController::class, 'approve']
			        )->name('approve');

			        Route::post(
			            '/{assetHandover}/reject',
			            [HandoverAssetHandoverController::class, 'reject']
			        )->name('reject');
			    });
